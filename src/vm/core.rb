module CVM
  ...
  # VM is a class responsible for simulating the bytecode. It has various helper functions to handle different kinds of nodes.
  class VM
    ...
    # Initialize values of attributes of a new instance of VM
    ...
    # Run the VM instance with input bytecode
    def run(opcodes = [])
